                ...
                For Each subdir As DirectoryInfo In dinfo.GetDirectories
                    ...
                    If My.Computer.FileSystem.DirectoryExists((subdir.FullName & "\Source Code\" & sourcecodedir & "\Required Files\").Replace("\\", "\")) Then
                        If My.Computer.FileSystem.FileExists((subdir.FullName & "\Source Code\" & sourcecodedir & "\Required Files\AutoUpdate.exe").Replace("\\", "\")) Then
                            If My.Computer.FileSystem.FileExists((subdir.FullName & "\Source Code\" & sourcecodedir & "\Required Files\7za.exe").Replace("\\", "\")) = False Then
                                If My.Computer.FileSystem.FileExists((Application.StartupPath & "\7za.exe").Replace("\\", "\")) = True Then
                                    My.Computer.FileSystem.CopyFile((Application.StartupPath & "\7za.exe").Replace("\\", "\"), (subdir.FullName & "\Source Code\" & sourcecodedir & "\Required Files\7za.exe").Replace("\\", "\"))
